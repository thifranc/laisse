...
/*   Updated: 2016/04/15 12:11:49 by thifranc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_info(char *path_file)
{
	...
	print_it("%s %d %s %s %d %s %s and name is:", get_type(lol.st_mode), lol.st_nlink, mdr->pw_name, xd->gr_name, (int)lol.st_size, "2015", path_file);
}
/*
